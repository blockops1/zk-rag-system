...
- `bm25_index.pkl`, `chunks/`, `embeddings/`, `extracted/`, `merkle_trees/`, `zk_proofs/`
- All archive/, wiki/, source_pdfs/
...
**Source:** `$REPO_DIR/shared/` (api_server.py + venv)
**Dest:** `$ZK_RAG_HOME/rag/`
...
Located at `$REPO_DIR/shared/sync_to_vps.sh`
